...
Version 1.6 of the docker compose installation of the solution for IDA includes:

- The implementation of the write-back implementation for automated IDA remediation through IDDM
- Various bug fixed and performance enhancements

> [!Warning] A database schema is necessary when upgrading to version 1.6.  
> Please follow the upgrade procedure detailed [here](../run-ops/upgrading) for more information.  

### Work item list

- **PP-727:** Write-back API implementation
- **PP-749:** Add Repository lineage for IDDM Active Directory
- **PP-750:** Add Repository lineage for IDDM LDAP
- **PP-768:** It is not possible to attach an IDDM remediation strategy to an OpenLDAP repository
- **PP-769:** The AD write back seems to fail for and AD repository
- **PP-771:** [CLI] Upgrade from 1.4 to 1.5 fails
- **PP-773:** RHEL logs are not generated
- **PP-774:** Removal of images can fail when upgrading the solution in RHEL
- **PP-778:** Write-back return warnings instead of errors
- **PP-781:** [Project] The 1.5 version of the project contains errors
- **PP-787:** Controller - (DBConnection.EncodeError) Postgrex expected an integer in -2147483648..2147483647
- **PP-790:** Automated upgrade from version 1.5
- **PP-791:** Azure AD extraction performance improvements

## Version 1.5

### Overview

Version 1.5 of the docker compose installation of the solution for IDA includes:
